...
import avoifaya from "../assets/avoifaya.png";

export const Sidebar = forwardRef<HTMLElement, { collapsed: boolean }>(({ collapsed }, ref) => {
    return (
        <aside
            ref={ref}
            className={cn(
        ...
        >
            <div className="flex gap-x-3 p-3">
                ...
                />
                {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">Avoifaya</p>}
            </div>
